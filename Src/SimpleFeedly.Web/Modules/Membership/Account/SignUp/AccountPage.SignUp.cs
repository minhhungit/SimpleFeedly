...
namespace SimpleFeedly.Membership.Pages
{
    ...
    public partial class AccountController : Controller
    {
        ...
        {
            return this.UseConnection("SimpleFeedlyConn", connection =>
            {
        ...
        {
            using (var connection = SqlConnections.NewByKey("SimpleFeedlyConn"))
            using (var uow = new UnitOfWork(connection))
            {
                int userId;
                try
