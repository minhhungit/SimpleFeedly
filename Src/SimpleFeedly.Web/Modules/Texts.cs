    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your SimpleFeedly Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to Simple Feedly";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your SimpleFeedly Account";
                    ...
                    public static LocalText FormTitle = "Sign up for SimpleFeedly";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "SimpleFeedly";
        }
