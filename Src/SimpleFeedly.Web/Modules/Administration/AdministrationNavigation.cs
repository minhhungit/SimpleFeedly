...
[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: SimpleFeedly.Administration.PermissionKeys.Security, icon: "fa-ban", Target = "_blank")]
