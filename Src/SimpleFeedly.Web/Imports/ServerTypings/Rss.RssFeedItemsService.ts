namespace SimpleFeedly.Rss {
    export namespace RssFeedItemsService {
        ...
        export declare function List(request: Common.MyBaseListRequest, onSuccess?: (response: Serenity.ListResponse<RssFeedItemsRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
