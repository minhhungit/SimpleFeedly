namespace SimpleFeedly.Rss {
    export namespace RssChannelsService {
        ...
        export declare function TestChannel(request: TestChannelRequest, onSuccess?: (response: Serenity.ListResponse<RssChannelsRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
