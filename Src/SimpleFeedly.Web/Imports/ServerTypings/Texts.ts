    ...
    declare namespace Db {
        ...
        namespace Rss {
            ...
            namespace Blacklists {
                export const Id: string;
                export const ShrinkedTitle: string;
                export const ShrinkedTitleHash: string;
            }

            namespace RssChannels {
                export const Copyright: string;
                export const Description: string;
                export const DomainGroup: string;
                ...
                export const OriginalDocument: string;
                export const RefreshTimeMinutes: string;
                export const RssCrawlerEngine: string;
                export const Title: string;
                export const Type: string;
            }

            namespace RssFeedItems {
                export const Author: string;
                export const ChannelId: string;
                export const Content: string;
                export const CoverImageUrl: string;
                export const Description: string;
                export const FeedItemKey: string;
                export const Id: string;
                export const IsChecked: string;
                export const Link: string;
                export const PublishingDate: string;
                export const RssChannelDomainGroup: string;
                export const RssChannelTitle: string;
                export const Title: string;
                export const XmlData: string;
            }
        }
    }
